...
public class QuizActivity extends ActionBarActivity {
	...
	private void checkAnswer(boolean userPressed)
	{
		...
		if (mIsCheater)
		{
			toastMessageId=R.string.judgement_toast;
		}
		else 
			{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mNextButton=(ImageButton)findViewById(R.id.next_imgbutton);
		...
		mPrevButton=(ImageButton)findViewById(R.id.prev_imgbutton);
